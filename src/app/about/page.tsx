        ...
        <div className="container-md">
          ...
          <div className="grid sm:grid-cols-2 gap-4 max-w-3xl mx-auto">
            {a.whyUs.points.map((point) => (
              <div key={point} className="flex items-start gap-3 p-4 rounded-xl bg-slate-50">
                <div className="mt-0.5 w-5 h-5 bg-brand-red rounded-full flex items-center justify-center flex-shrink-0">
